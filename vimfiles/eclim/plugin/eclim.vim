...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = 'C:/dev/eclipse/sts/sts-2.6.0.RELEASE/sts-2.6.0.RELEASE/plugins/org.eclim_1.6.3'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = 'C:/dev/eclipse/sts/sts-2.6.0.RELEASE/sts-2.6.0.RELEASE'
  if has('win32unix')
